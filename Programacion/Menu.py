...
while opc != "34":
    ...
    if opc == "1":
        opc1 = ""
        os.system("cls")
        Elementos = (input("Ponga su Nombre"))
        if Elementos  == "":
            ele=3
        else:
            ele= Elementos
    ...
    if opc == "3":  
        ...
        print("...Persona...")
        persona1=Persona()
        persona1.apellidos = "Ruben Vacacela"
        print(persona1.apellidos)
        persona1.despertar()
        print(persona1.despierta)

        persona2 = Persona()
        persona2.apellidos = "Carlos Carrera"
        ...
        os.system("cls")
        print("...Curso...")
        curso1 = Curso("Economica", 5, "Ingeniería Software")
        print(curso1)
        curso1.mostrarDatos()
        input("Continuar")    
    elif opc == "29":
        ...
        os.system("cls")
        print("...Cuenta...")
        cuenta1 = Cuenta("Joel Carpio", 1500, "Dolares")
        ...
        os.system("cls")
        print("...Herencia...")
        estu1 = Estudiante("Mateo", "Ismael", "Jesus", "Ingeniería Software")
        ...
        pais1 = Pais("Colombia", "Roberto Delgado")
        print(pais1)

        ciudad1 = Ciudad("Jujan", 1500, pais1)
        print(ciudad1)

        urba1 = Urbanizacion("Villa del Rey", ciudad1)
        print(urba1)
        input("Continuar")
